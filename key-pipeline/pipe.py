...
def pathrider():
  ...
  param = 'sh ./supmat/2-pathrider/scripts/run-pathrider.sh %s %s %s %s' % (ns.sif, ns.dir, ns.b, ns.b_gen_prot)
...
required.add_argument('--b_gen_prot', help='a list of blacklisted genes with prefic _gen or _prot')
