...
time python3 ./supmat/4-validation/scripts/pickrandom-percentage.py --scripts-path ./supmat/3-iggy/scripts/ --iggy-command "$IGGY" ./supmat/2-pathrider/data/out-filtered.sif ./supmat/0-diff-analysis/data/diffexp_filtered.csv ./supmat/4-validation/data/name-true-up_gen.csv ./supmat/4-validation/data/name-true-down_gen.csv $START_SAMPLING $STOP_SAMPLING $STEP_SAMPLING $NUMBER_RUNS "$OUTDIR"
